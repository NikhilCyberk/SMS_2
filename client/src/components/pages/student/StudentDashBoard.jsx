...
// //     axios
// //       .get(`http://localhost:3000/get-student-detail/${student_id}`) // replace '123' with dynamic ID as needed
// //       .then((response) => {
...
// //       <p>Class: {student.sclassName.sclassName}</p>
// //       <p>School: {student.school.schoolName}</p>
// //     </div>
// //   );
// // };
...
//           <p className="text-lg">Roll Number: {student.rollNum}</p>
//           <p className="text-lg">Class: {student.sclassName.sclassName}</p>
//           <p className="text-lg">School: {student.school.schoolName}</p>
//         </div>
//       </div>
//     </div>
//   );
