  ...
  return (
    <div className="flex justify-center items-center  bg-gray-900">
      <div className="bg-gray-800 shadow-lg rounded-lg w-full max-w-md p-8">
        <h2 className="text-2xl font-bold mb-6 text-white">Create Subjects</h2>
        <form onSubmit={handleSubmit}>
          {subjects.map((subject, index) => (
            <div key={index} className="mb-4">
              <label className="block font-medium mb-2 text-gray-300">
                ...
                <input
                  ...
                  className="w-full bg-gray-700 text-white border-gray-600 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                />
              </label>
              <label className="block font-medium mb-2 text-gray-300">
                Subject Code:
